#!/bin/bash
#SBATCH --job-name=train_jdmp_mini_attforecast_graddetach_qembshare_6lay_attmem_bs16_1gpu_600e    # Job name
...
NUM_GPUS=1
CFG_NAME=jdmp_mini_attforecast_graddetach_qembshare_6lay_attmem_bs16_1gpu_600e
