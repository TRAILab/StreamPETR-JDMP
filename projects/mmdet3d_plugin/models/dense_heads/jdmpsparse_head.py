...
class JDMPSparseHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is JDMPSparseHead):
        ...
        super(JDMPSparseHead, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def forward(self, img_metas, **data):
        ...
        outs_dec = self.detect_transformer(tgt, query_pos, feat_flatten, spatial_flatten, level_start_index, temp_memory, 
