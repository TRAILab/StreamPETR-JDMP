from projects.mmdet3d_plugin.metrics.metric import Metric
from typing import Dict, Union
import torch
from projects.mmdet3d_plugin.metrics.utils import miss_rate
...
class MissRateK(Metric):
    ...
    def compute(self, predictions: Dict, ground_truth: Union[Dict, torch.Tensor]) -> torch.Tensor:
        ...
        """
        # Unpack arguments
        traj = torch.from_numpy(predictions['traj'])
