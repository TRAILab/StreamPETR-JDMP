    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='JDMP',
                name='jdmpvov_mini_cvforecast_noprop_bs8_1gpu'),
            interval=50)
    ])
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_forecast_cls=dict(type='CrossEntropyLoss', use_sigmoid=True, loss_weight=0.0),
...
load_from='ckpts/jdmpvov_pretrain_baseline.pth'
resume_from=None
